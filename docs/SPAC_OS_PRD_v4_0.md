...
| File | Path | Purpose |
|------|------|---------|
| This PRD | /SPAC OS/documentation/PRDs/SPAC_OS_PRD_v4.0.md | Master reference |
| Previous PRD | /SPAC OS/documentation/PRDs/SPAC_OS_PRD_v3.0.md | Legacy reference |
...
|--------|------------|------------------|
| Sprint 1 | Foundation & Auth | Next.js setup, Clerk auth, Dashboard shell |
| Sprint 2 | SPAC Management | SPAC CRUD, Lifecycle, Timeline |
...
*This PRD serves as the single source of truth for the SPAC OS v4.0 project.*
