...
import { cn, formatLargeNumber, slugify } from '@/lib/utils';
...
function AddOrganizationForm({ isOpen, onClose, onSubmit, isLoading }: AddOrganizationFormProps) {
  const [formData, setFormData] = useState<NewOrganizationData>({
    name: '',
    slug: '',
    type: 'PE_FIRM',
    subType: undefined,
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData((prev) => ({ ...prev, subType: e.target.value as OrganizationSubType || undefined }))}
                  className="input w-full"
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="number"
                  value={formData.aum || ''}
                  onChange={(e) => setFormData((prev) => ({ ...prev, aum: e.target.value ? Number(e.target.value) : undefined }))}
                  className="input w-full"
